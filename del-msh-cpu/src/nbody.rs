...
impl Model for Elastic {
    fn eval(&self, r: &[f32;3], rhs_j: &[f32; 3]) -> [f32; 3] {
        ...
        let coeff_i = self.norm * ((self.a - self.b) * r_eps_inv + 0.5 * self.a * self.eps * self.eps * r_eps3_inv);
...
{
    let linear_world2unit = del_geo_core::mat4_col_major::to_mat3_col_major_xyz(transform_world2unit);
    let svd = del_geo_core::mat3_col_major::svd(&linear_world2unit, del_geo_core::mat3_sym::EigenDecompositionModes::JacobiNumIter(10)).unwrap();
    let svd_scale = svd.1;
    dbg!(svd_scale);
    ...
    fn get_force<M: Model>(
        ...
        if dist_unit - delta_unit > 0. && celllen_unit < (dist_unit - delta_unit) * theta {
            ...
            let pos_relative_world = del_geo_core::vec3::scale(&pos_relative_unit, scale_unit2world);
        ...
        for j_child in 0..8 {
            ...
            if j_onode_child == u32::MAX { continue; }
    ...
    for i_vtx in 0..num_vtx {
        ...
        let pos_unit = del_geo_core::mat4_col_major::transform_homogeneous(
