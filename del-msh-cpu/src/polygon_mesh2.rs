...
pub fn elem2area(elem2idx_offset: &[usize], idx2vtx: &[usize], vtx2xy: &[[f32; 2]]) -> Vec<f32> {
    ...
    for i_elem in 0..num_elem {
        ...
        for i_edge in 0..num_vtx_in_elem {
            ...
            areas[i_elem] += 0.5f32 * vtx2xy[i0_vtx][0] * vtx2xy[i1_vtx][1];
            areas[i_elem] -= 0.5f32 * vtx2xy[i0_vtx][1] * vtx2xy[i1_vtx][0];
        }
    }
    areas
}
