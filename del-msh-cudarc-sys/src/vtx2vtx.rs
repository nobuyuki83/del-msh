...
pub fn from_uniform_mesh(
    ...
    let (vtx2jdx, jdx2elem) = crate::vtx2elem::from_uniform_mesh(stream, elem2vtx, num_elem, num_vtx);
    ...
    {
        let (func, _mdl) =
            del_cudarc_sys::load_function_in_module(del_msh_cuda_kernel::VTX2VTX, "vtx2nvtx_from_uniform_mesh");
    ...
    {
        let (func, _mdl) =
            del_cudarc_sys::load_function_in_module(del_msh_cuda_kernel::VTX2VTX, "idx2vtx_from_vtx2buff_for_uniform_mesh");
        let mut builder = del_cudarc_sys::Builder::new(stream);
        builder.arg_i32(num_vtx as i32);
        builder.arg_dptr(vtx2jdx.dptr);
        builder.arg_i32(num_node as i32);
