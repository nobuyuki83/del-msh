...
impl candle_core::InplaceOp2 for SortedMortonCode {
    ...
    fn cuda_fwd(
        ...
        get_cuda_slice_device_from_storage_u32!(
            sorted_morton_code,
            dev_sorted_morton_code,
            sorted_morton_code
        );
        ...
        let transform_cntr2uni = {
            ...
            dev_sorted_morton_code.memcpy_stod(&transform_cntr2uni_cpu)?
        };
        ...
        .w()?;
        dev_sorted_morton_code.memcpy_dtod(&vtx2morton, &mut idx2morton)?;
        Ok(())
    }
}
...
impl candle_core::InplaceOp2 for BvhNodesFromSortedMortonCode {
    ...
    fn cuda_fwd(
        ...
        use candle_core::cuda_backend::CudaStorageSlice;
        use candle_core::cuda_backend::WrapErr;
        get_cuda_slice_device_from_storage_u32!(bvhnodes, device_bvhnodes, bvhnodes);
