...
pub const MORTONS: &str = include_str!(concat!(env!("OUT_DIR"), "/mortons.ptx"));
pub const NBODY: &str = include_str!(concat!(env!("OUT_DIR"), "/nbody.ptx"));
...
pub const QUAD_OCT_TREE: &str = include_str!(concat!(env!("OUT_DIR"), "/quad_oct_tree.ptx"));
