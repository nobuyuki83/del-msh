...
def bwd_antialias(edge2vtx_contour, vtx2xyz, dldw_vtx2xyz, transform_world2pix, dldw_pixval, pix2tri, stream_ptr=0):
    from ..del_msh_dlpack import differential_rasterizer_bwd_antialias

    differential_rasterizer_bwd_antialias(edge2vtx_contour, vtx2xyz, dldw_vtx2xyz, transform_world2pix, dldw_pixval, pix2tri, stream_ptr)
