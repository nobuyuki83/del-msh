...
def antialias(edge2vtx_contour, vtx2xyz, transform_world2pix, pix2tri, img_data):
    from ..del_msh_dlpack import differential_rasterizer_antialias

    differential_rasterizer_antialias(edge2vtx_contour, vtx2xyz, transform_world2pix, pix2tri, img_data)
