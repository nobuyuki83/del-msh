...
def contour_for_triangle_mesh(
    tri2vtx, vtx2xyz, transform_world2ndc, edge2vtx, edge2tri, stream_ptr=0
):
    from ..del_msh_dlpack import edge2vtx_contour_for_triangle_mesh

    return edge2vtx_contour_for_triangle_mesh(
        tri2vtx, vtx2xyz, transform_world2ndc, edge2vtx, edge2tri, stream_ptr
    )
