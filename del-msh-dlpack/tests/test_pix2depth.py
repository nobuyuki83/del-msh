...
def test_cpu_cuda_match_with_autograd():
    ...
    pix2depth = Pix2Depth.AutogradFunction.apply(vtx2xyz, pix2tri, tri2vtx, transform_ndc2world)
    ...
    if torch.cuda.is_available():
        ...
        d_pix2tri = Pix2Tri.by_raycasting(d_tri2vtx, d_vtx2xyz, d_bvhnodes, d_bvhnode2aabb, d_transform_ndc2world,
                                          img_shape)
        assert torch.equal(d_pix2tri.cpu(), pix2tri)
        d_pix2depth = Pix2Depth.AutogradFunction.apply(d_vtx2xyz, d_pix2tri, d_tri2vtx, d_transform_ndc2world)
...
def test_match_with_interpolate():
    ...
    vtx2xyz.requires_grad = True
    vtx2xyz.grad = None
    pix2depth0 = Pix2Depth.AutogradFunction.apply(vtx2xyz, pix2tri, tri2vtx, transform_ndc2world)
    ...
    vtx2xyz.requires_grad = True
    vtx2xyz.grad = None
    pix2depth1 = Pix2Depth.pix2depth_using_interpolation(vtx2xyz, pix2tri, tri2vtx, transform_ndc2world)
