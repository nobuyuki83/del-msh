...
pub fn extract<'a>(
    ...
    num_tri_new: usize)
    -> (Bound<'a, PyArray1<usize>>, usize, Bound<'a, PyArray1<usize>>)
{
    ...
    (
        numpy::ndarray::Array1::from_vec(tri2vtx_new).into_pyarray_bound(py),
        num_vtx_new,
        numpy::ndarray::Array1::from_vec(vtx2vtx_new).into_pyarray_bound(py)
    )
}
