...
use pyo3::{Python, pyfunction, types::PyModule, PyResult, Bound};
...
fn triangles_from_polygon_mesh<'a>(
    ...
    idx2vtx: PyReadonlyArray1<'a, usize>) -> Bound<'a, PyArray2<usize>> {
...
fn vtx2vtx_trimesh<'a>(
    ...
    num_vtx: usize,
    is_self: bool) -> (Bound<'a, PyArray1<usize>>, Bound<'a, PyArray1<usize>>) {
...
fn group_connected_element_uniform_polygon_mesh<'a>(
    ...
    num_vtx: usize) -> (usize, Bound<'a, PyArray1<usize>>)
{
